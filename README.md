# Victory Lap Barber Shop

Sito statico HTML/CSS/JS per Victory Lap Barber Shop, barberia a Bra con identita' camo, musica trap e tono street-premium.
...
## Apertura locale
Il sito non richiede build. Si puo' aprire `index.html` direttamente nel browser oppure servire la cartella `output/` con un server statico.
